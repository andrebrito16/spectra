...
nonisolated enum ResourceKindIcon {
    ...
    static func symbol(forKind kind: String) -> String {
        ...
        case "GatewayClass": return "square.stack.3d.up"
        case "HTTPRoute", "GRPCRoute", "TLSRoute", "TCPRoute", "UDPRoute": return "arrow.triangle.branch"
        case "ReferenceGrant": return "link.badge.plus"
        case "Application": return "app.connected.to.app.below.fill"
        case "ApplicationSet": return "square.stack.3d.up"
        case "AppProject": return "folder"
        case "Rollout": return "arrow.triangle.2.circlepath"
        case "AnalysisRun": return "chart.xyaxis.line"
        case "AnalysisTemplate", "ClusterAnalysisTemplate": return "doc.text.magnifyingglass"
    ...
    static func symbol(forSection section: String) -> String {
        ...
        case "Argo CD": return "arrow.triangle.2.circlepath"
